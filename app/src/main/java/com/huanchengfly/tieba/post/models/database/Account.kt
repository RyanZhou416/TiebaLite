...
data class Account(
    ...
    @ColumnInfo(name = "postnum")
    var postNum: String? = null,
    @ColumnInfo(name = "threadnum")
    var threadNum: String? = null,
    @ColumnInfo(name = "concernnum")
    var concernNum: String? = null,
    @ColumnInfo(name = "tbage")
    var tbAge: String? = null,
    var age: String? = null,
    @ColumnInfo(name = "birthdayshowstatus")
    var birthdayShowStatus: String? = null,
    @ColumnInfo(name = "birthdaytime")
    var birthdayTime: String? = null,
    var constellation: String? = null,
    @ColumnInfo(name = "tiebauid")
    var tiebaUid: String? = null,
    @ColumnInfo(name = "loadsuccess")
